...
class Pythia(BaseModel):
    def __init__(self, config):
        ...
        self.config = config
        self._global_config = registry.get("config") # saving all the functions "_..."
    ...
    def _init_feature_encoders(self, attr):
        ...
        setattr(self, attr + "_feature_encoders", nn.ModuleList(feat_encoders)) # here they get 0 and 1 indexes
