...
# MMF VQA-Model for the OK-VQA Dataset
# Based on ConcatBERT from MMF.sh, used for the Hateful Memes dataset; https://mmf.sh/docs/tutorials/concat_bert_tutorial
...
class OKVQAbaseline(BaseModel):
    ...
    def config_path(cls):
        ...
        return "configs/models/OKVQAbaseline/defaults.yaml"
